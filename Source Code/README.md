...
- เลือกวัน–เวลาที่ต้องการบันทึกเองได้ เช่น 1/6/2569 (ระบบรับค่าเป็น `2026-06-01`)
- โหมด `ย้อนหลังไม่ระบุวัน` ตัดแถบ timestamp ที่ฝังมากับภาพกล้องออกจากภาพที่บันทึกทุกช่อง
...
- `CCTV_TIMESTAMP_CROP_TOP_PIXELS`: ความสูงแถบด้านบนที่โหมดย้อนหลังไม่ระบุวันตัดออก ค่าเริ่มต้น 110 พิกเซล
